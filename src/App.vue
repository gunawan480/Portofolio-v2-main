<template>
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-lg text-primary-blue font-semibold whitespace-nowrap fadein-bot hover:text-blue-300"> Ahmad Syah Gunawan </span>
        </button>
      <div class="flex md:order-2 ml-4 items-center"> <a href="https://github.com/gunawan480" target="_blank" rel="noopener noreferrer">
          <img :src="require('@/assets/github.png')" class="w-9 h-9 rounded-full transition duration-300 ease-in-out hover:scale-110" alt="GitHub"/></a>
      </div>
  ...
  <nav class="flex justify-around py-4 text-xs">
    ...
    <router-link to="/blog" class="text-gray-300 hover:text-white">Social Media</router-link>
  </nav>
</footer>
</template>
