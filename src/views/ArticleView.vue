  ...
  <div class="w-full md:w-3/5 h-20 mx-auto md:mt-5">
    <div class="bg-white rounded-xl mx-3 p-5 md:p-10 md:mx-0">
      <div>
        ...
        <!-- ⬇️ GANTI warna baris ini -->
        <div class="h-[2px] w-20 my-5 md:my-10 bg-blue-400 md:w-1/3 aos-init aos-animate mr-2"></div>
        <div>
...
export default {
    ...
    methods: {
        async getDetails() {
            ...
            axios.get('https://686b6266e559eba908724bef.mockapi.io/articles/' + id)
                .then(response => {
